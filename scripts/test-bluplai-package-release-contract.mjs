...
const expectedRelease = {
  schema_version: 1,
  release_id:
    "@bluplai/buzz-chat-react@0.1.0-bluplai.13+aee6fa91686b4fadaadc68b4e4074286585bc3c0",
  source: {
    repository: "https://github.com/skyremote/bluplai-buzz",
    package_path: "packages/bluplai-chat-react",
    package_commit: "aee6fa91686b4fadaadc68b4e4074286585bc3c0",
    package_tree: "db5df8bbdaa4954f83f7e820c3beab3c43c27424",
  ...
  package: {
    ...
    version: "0.1.0-bluplai.13",
    filename: "bluplai-buzz-chat-react-0.1.0-bluplai.13.tgz",
    sha256: "801fcf972d3584b125a0e659bb143b22e2b8f9ab599dbe404f8835479278185d",
  },
  attestation: {
...
function assertExactLiveAttestationContract(documentation) {
  ...
  assert.match(
    documentation,
    /gh attestation verify bluplai-buzz-chat-react-0\.1\.0-bluplai\.13\.tgz/u,
  );
  assert.match(
    documentation,
