...
mod tests {
    ...
    fn embedded_migrator_contains_consolidated_initial_schema() {
        ...
        // The upstream channel index and reaction widening originally arrived
        // as 0027/0028. Bluplai deployments already own those immutable
        // versions, so the upstream SQL is adopted verbatim as 0029/0030.
        // Channel-id lookup index (0029): serves the tenant-independent
