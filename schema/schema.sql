...
-- ── Bluplai managed-room integration ────────────────────────────────────────
-- Keep this desired-state schema aligned with additive migrations 0027 and
-- 0028. Fresh/CI databases are created from this file before the relay starts,
-- while existing installations receive the same objects through sqlx.
